  ...
  <svg width="30" height="30" viewBox="0 0 1024 1024" class="icon" version="1.1" xmlns="http://www.w3.org/2000/svg" fill="#000000">
    ...
    <g id="SVGRepo_iconCarrier">
      <path
        ...
        fill="#333E48"></path>
      <path d="M951.5 896H540.4v43h411.1c4.2 0 7.7-3.5 7.7-7.7v-27.6c0-4.3-3.4-7.7-7.7-7.7z" fill="#00AD68"></path>
      <path d="M133.6 183.6h432v712.3h-432z" fill="#D1D3D3"></path>
      <path d="M133.6 183.6h432v98.6h-432z" fill=""></path>
      <path d="M187.6 613.8h324v87.8h-324z" fill="#FFFFFF"></path>
      <path d="M187.6 613.8h324v32.3h-324z" fill=""></path>
      <path d="M335.3 613.8h28.6v87.8h-28.6z" fill="#333E48"></path>
      <path
        ...
        fill="#0071CE"></path>
      <path d="M187.6 469h324v87.8h-324z" fill="#FFFFFF"></path>
      <path d="M187.6 469h324v32.3h-324z" fill=""></path>
      <path d="M335.3 469h28.6v87.8h-28.6z" fill="#333E48"></path>
      <path
        ...
        fill="#0071CE"></path>
      <path d="M187.6 324.2h324V412h-324z" fill="#FFFFFF"></path>
      <path d="M187.6 324.2h324v32.3h-324z" fill=""></path>
      <path d="M335.3 324.2h28.6V412h-28.6z" fill="#333E48"></path>
      <path
        ...
        fill="#0071CE"></path>
      <path d="M266.1 772.8h167V896h-167z" fill="#FFFFFF"></path>
      <path d="M335.3 772.8h28.6V896h-28.6z" fill="#333E48"></path>
      <path d="M447.4 896h-28.6V787.1H280.4V896h-28.6V772.8c0-7.9 6.4-14.3 14.3-14.3h167c7.9 0 14.3 6.4 14.3 14.3V896z"
        fill="#0071CE"></path>
      <path
      ...
      <path
        ...
        fill="#FFFFFF"></path>
      <path d="M565.6 571.3h324.2V896H565.6z" fill="#D1D3D3"></path>
      <path d="M619.7 662.4h216v87.8h-216z" fill="#FFFFFF"></path>
      <path d="M619.7 662.4h216v32.3h-216z" fill=""></path>
      <path d="M713.4 662.4H742v87.8h-28.6z" fill="#333E48"></path>
      <path
      ...
      <path d="M601.7 590.2v-74.8h-36.1V896h36.1V626.6h288.1v-36.4z" fill=""></path>
      <path d="M819.5 896c0-33.8-27.4-61.1-61.1-61.1-33.8 0-61.1 27.4-61.1 61.1h122.2z" fill="#218649"></path>
    </g>
  </svg>
</template>
