<template>
  <svg width="26" height="26" viewBox="0 0 1024 1024" class="icon" version="1.1" xmlns="http://www.w3.org/2000/svg" fill="#000000">
    ...
    <g id="SVGRepo_iconCarrier">
      <path
        ...
        fill="#FDCD60"></path>
      <path d="M159 715l-21-5 21-5 5-21 5 21 21 5-21 5-5 21-5-21z" fill="#FDCD60"></path>
      <path d="M244 247m-9 0a9 9 0 1 0 18 0 9 9 0 1 0-18 0Z" fill="#5546CB"></path>
      <path d="M288 821l-27-6 27-7 6-27 7 27 27 7-27 6-7 27-6-27z" fill="#FDCD60"></path>
